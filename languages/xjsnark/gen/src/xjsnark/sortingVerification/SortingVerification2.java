...
public class SortingVerification2 extends CircuitGenerator {
  ...
  public static void main(String[] args) {
    ...
    new SortingVerification2();
  }

  public SortingVerification2() {
    super("SortingVerification2");
    __generateCircuit();
  ...
  public void outsource() {
    ...
    new PermutationVerifier(unsortedArray, sortedArray, "", UnsignedInteger.__getClassRef(), new Object[]{"16"});
