...
public class PrivateKey extends StructDefinition {
  ...
  public void __makeInput() {
    ...
    a_sk = (UnsignedInteger[]) UnsignedInteger.createInputArray(CircuitGenerator.__getActiveCircuitGenerator(), Util.getArrayDimensions(a_sk), 32);
  ...
  public void __makeWitness() {
    ...
    a_sk = (UnsignedInteger[]) UnsignedInteger.createWitnessArray(CircuitGenerator.__getActiveCircuitGenerator(), Util.getArrayDimensions(a_sk), 32);
  ...
  public void __makeVerifiedWitness() {
    ...
    a_sk = (UnsignedInteger[]) UnsignedInteger.createVerifiedWitnessArray(CircuitGenerator.__getActiveCircuitGenerator(), Util.getArrayDimensions(a_sk), 32);
