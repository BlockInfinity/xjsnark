...
public class PourCircuit extends CircuitGenerator {
  ...
  public static void main(String[] args) {
    ...
    // - If the multivariate optimizer is enabled, it will require high memory usage (about 5~6G  
    //  if the Config.arithOptimizerIncrementalMode is enabled. 
  ...
  public void outsource() {
    ...
    // Verifying that there are no overflows. Adding two uint_64 variables directly could overflow mod 2^64 
    // To detect an overflow, we do the check in a larger range 
