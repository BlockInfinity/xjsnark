...
public class Types extends CircuitGenerator {
  ...
  public void outsource() {
    ...
    {
      Bit bit_i0q = input.isEqualTo(UnsignedInteger.instantiateFrom(32, k)).copy();
      boolean c_i0q = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_i0q);
      if (c_i0q) {
        if (bit_i0q.getConstantValue()) {
        ...
        ConditionalScopeTracker.push(bit_i0q);
        output.assign(new UnsignedInteger(32, new BigInteger("1")), 32);
