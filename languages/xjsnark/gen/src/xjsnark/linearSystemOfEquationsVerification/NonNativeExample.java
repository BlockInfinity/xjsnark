...
public class NonNativeExample extends CircuitGenerator {
  ...
  public static void main(String[] args) {
    ...
    new NonNativeExample();
  }

  public NonNativeExample() {
    super("NonNativeExample");
    __generateCircuit();
  ...
  public void __init() {
    a1 = (FieldElement[]) FieldElement.createZeroArray(CircuitGenerator.__getActiveCircuitGenerator(), new int[]{2}, new BigInteger("257"));
    a2 = (FieldElement[]) FieldElement.createZeroArray(CircuitGenerator.__getActiveCircuitGenerator(), new int[]{2}, new BigInteger("257"));
    b = (FieldElement[]) FieldElement.createZeroArray(CircuitGenerator.__getActiveCircuitGenerator(), new int[]{2}, new BigInteger("257"));
    solution = (FieldElement[]) FieldElement.createZeroArray(CircuitGenerator.__getActiveCircuitGenerator(), new int[]{2}, new BigInteger("257"));
  }
  ...
  public void __defineInputs() {
    ...
    a1 = (FieldElement[]) FieldElement.createInputArray(CircuitGenerator.__getActiveCircuitGenerator(), Util.getArrayDimensions(a1), new BigInteger("257"));
    a2 = (FieldElement[]) FieldElement.createInputArray(CircuitGenerator.__getActiveCircuitGenerator(), Util.getArrayDimensions(a2), new BigInteger("257"));
    b = (FieldElement[]) FieldElement.createInputArray(CircuitGenerator.__getActiveCircuitGenerator(), Util.getArrayDimensions(b), new BigInteger("257"));
  ...
  public void __defineVerifiedWitnesses() {
    ...
    solution = (FieldElement[]) FieldElement.createVerifiedWitnessArray(CircuitGenerator.__getActiveCircuitGenerator(), Util.getArrayDimensions(solution), new BigInteger("257"));
  ...
  public void outsource() {
    ...
    CircuitGenerator.__getActiveCircuitGenerator().__specifyProverWitnessComputation(new Instruction() {
      public void evaluate(CircuitEvaluator p0) {
        ...
        BigInteger[] s_vals = xjsnark.linearSystemOfEquationsVerification.Util.solve(a1_vals, a2_vals, b_vals, new BigInteger("257"));
    ...
    // What's being checked in the circuit (This will be more expensive than the native case) 
